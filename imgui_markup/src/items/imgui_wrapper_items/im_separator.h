#ifndef IMGUI_MARKUP_SRC_ITEMS_IMGUI_WRAPPER_ITEMS_IM_SEPARATOR_H_
#define IMGUI_MARKUP_SRC_ITEMS_IMGUI_WRAPPER_ITEMS_IM_SEPARATOR_H_

/**
 * @file im_separator.h
 * @author FluxxCode (info.fluxxcode@gmail.com)
 * @brief Contains item 'ImSeparator'
...
class ImSeparator : public ImWrapperItemBase
{
public:
    ImSeparator(std::string id, ItemBase* parent);
...
#endif  // IMGUI_MARKUP_SRC_ITEMS_IMGUI_WRAPPER_ITEMS_IM_SEPARATOR_H_
