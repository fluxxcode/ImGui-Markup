#ifndef IMGUI_MARKUP_SRC_ITEMS_IMGUI_WRAPPER_ITEMS_IM_INVISIBLE_BUTTON_H_
#define IMGUI_MARKUP_SRC_ITEMS_IMGUI_WRAPPER_ITEMS_IM_INVISIBLE_BUTTON_H_

/**
 * @file im_invisible_button.h
 * @author FluxxCode (info.fluxxcode@gmail.com)
 * @brief Contains item 'ImInvisibleButton'
...
class ImInvisibleButton : public ImWrapperItemBase
{
public:
    ImInvisibleButton(std::string id, ItemBase* parent);
...
#endif  // IMGUI_MARKUP_SRC_ITEMS_IMGUI_WRAPPER_ITEMS_IM_INVISIBLE_BUTTON_H_
